		...
		<div class="container">
			...
			<div class="registration">
				<div class="registration_left">
					<h2>
						new user? <span> create an customer account </span>
					</h2>
					<!-- [if IE] 
					...
					<div class="registration_form">
						...
						<form:form modelAttribute="customerRegistrationForm"
							action="${pageContext.request.contextPath}/add-customer.htm" method="post">
							...
							<div>
								<label>
									<input name="emailAddress" placeholder="email address:" type="email" tabindex="3" required>
								</label>
							</div>
							<div>
								<label>
							...
							<div>
								<label>
									<input name="retypePassword" placeholder="retype password" type="password" tabindex="4" required>
								</label>
							</div>
							<div>
								<label>
									<input name="role" value="Customer" placeholder="roleName" type="hidden" tabindex="4" required>
								</label>
							</div>
							<div>
							...
							<div class="sky-form">
								<label class="checkbox">
									<input name="termsAndConditions" type="checkbox" name="checkbox"> 
									<i></i>I Read &amp; Accept &nbsp;
